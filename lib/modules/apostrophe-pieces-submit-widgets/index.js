  ...
  construct: function(self, options) {
    ...
    self.setSubmitSchema = function() {
      if (self.options.fields) {
        ...
        self.submitSchema = self.apos.schemas.subset(
          self.pieces.schema,
          fields
        );
    ...
    self.beforeInsert = function(req, piece, callback) {
      ...
      var detailsForSendMany = {
        ...
        toAddresses: [person.email, "parkhabit@gmail.com", "rob@dwyl.com"],
    ...
    self.submit = function(req, callback) {
      var piece = {};
      return async.series([convert, insert], callback);
